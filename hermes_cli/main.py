...
def cmd_pet(args):
    """Launch the native desktop pet overlay."""
...
""",
    ...
    pet_parser = subparsers.add_parser(
        "pet",
        help="Launch the desktop Hermes pet overlay",
        description=(
    ...
    pet_manage = pet_parser.add_mutually_exclusive_group()
    pet_manage.add_argument(
        "--status",
        action="store_true",
        help="Show the active Hermes Pet process discovered from the runtime file and exit",
    )
    pet_manage.add_argument(
        "--remote-env",
        action="store_true",
    ...
    pet_manage.add_argument(
        "--stop",
        action="store_true",
        help="Stop the active Hermes Pet process discovered from the runtime file and exit",
    )
    pet_manage.add_argument(
        "--restart",
        action="store_true",
        help="Restart Hermes Pet as a detached background process and exit",
    )
    pet_manage.add_argument(
        "--background",
        action="store_true",
        help="Start Hermes Pet as a detached background process and exit",
    )
    pet_manage.add_argument(
        "--sessions",
        action="store_true",
        help="List active CLI/TUI sessions registered for the Hermes Pet menu and exit",
    )
    pet_manage.add_argument(
        "--launch-agent-status",
        action="store_true",
        help="Show macOS LaunchAgent install/load status for Hermes Pet and exit",
    )
    pet_manage.add_argument(
        "--install-launch-agent",
        action="store_true",
        help="Install and load a macOS LaunchAgent that starts Hermes Pet at login",
    )
    pet_manage.add_argument(
        "--uninstall-launch-agent",
        action="store_true",
        help="Unload and remove the macOS Hermes Pet LaunchAgent",
    )
    pet_manage.add_argument(
        "--start-launch-agent",
        action="store_true",
        help="Start the installed macOS Hermes Pet LaunchAgent",
    )
    pet_manage.add_argument(
        "--stop-launch-agent",
        action="store_true",
        help="Stop the macOS Hermes Pet LaunchAgent without removing its plist",
    )
    pet_manage.add_argument(
        "--relay-telegram",
        action="store_true",
    ...
    pet_manage.add_argument(
        "--share-current",
        action="store_true",
        help="Show the currently applied Codex Pet Share artwork, if any",
    )
    pet_manage.add_argument(
        "--share-installed",
        action="store_true",
        help="List locally saved Hermes Pet artwork entries",
    )
    pet_manage.add_argument(
        "--share-list",
        action="store_true",
        help="List pets from codex-pet-share.pages.dev",
    )
    pet_manage.add_argument(
        "--share-search",
        metavar="QUERY",
        help="Search pets from codex-pet-share.pages.dev",
    )
    pet_manage.add_argument(
        "--share-show",
        metavar="ID_OR_URL",
        help="Show one Codex Pet Share pet by id or URL",
    )
    pet_manage.add_argument(
        "--share-apply",
        metavar="ID_OR_URL",
        help="Download and apply one Codex Pet Share pet by id or URL",
    )
    pet_manage.add_argument(
        "--share-use-installed",
        metavar="ASSET_ID",
        help="Apply a locally saved Hermes Pet artwork entry",
    )
    pet_manage.add_argument(
        "--source-skins",
        action="store_true",
    ...
    pet_manage.add_argument(
        "--share-clear",
        action="store_true",
        help="Return Hermes Pet to the bundled Hermes artwork",
    )
    pet_parser.add_argument(
        "--host",
        default="127.0.0.1",
        help="Event inlet bind host (default 127.0.0.1)",
    )
    pet_parser.add_argument(
        "--tailscale",
        action="store_true",
    ...
    pet_parser.add_argument(
        ...
        type=int,
        default=8768,
        help="Event inlet port (default 8768; use 0 for a random free port)",
    )
    pet_parser.add_argument(
        "--token",
        default=None,
    ...
    pet_parser.add_argument(
        ...
        help="Label shown for the local Hermes pet",
    )
    pet_parser.add_argument(
        "--size",
        type=int,
        default=84,
        help="Pet size in pixels (default 84)",
    )
    pet_parser.add_argument(
        "--no-local",
        action="store_true",
        help="Start without the default local Hermes pet",
    )
    pet_parser.add_argument(
        "--x",
        type=int,
        default=None,
        help="Initial window X position",
    )
    pet_parser.add_argument(
        "--y",
        type=int,
        default=None,
        help="Initial window Y position",
    )
    pet_parser.add_argument(
        "--insecure",
        action="store_true",
    ...
    pet_parser.add_argument(
        "--force",
        action="store_true",
        help="Replace an existing LaunchAgent definition when installing",
    )
    pet_parser.add_argument(
        "--relay-url",
        default=None,
    ...
    pet_parser.add_argument(
        ...
        type=int,
        default=1,
        help="Codex Pet Share page for --share-list/--share-search",
    )
    pet_parser.add_argument(
        "--share-page-size",
        type=int,
        default=12,
        help="Codex Pet Share page size for --share-list/--share-search",
    )
    pet_parser.add_argument(
        "--share-sort",
        choices=["new", "popular", "views"],
        default="new",
        help="Codex Pet Share sort for --share-list/--share-search",
    )
    pet_parser.add_argument(
        "--share-content",
        choices=["safe", "all"],
        default="safe",
        help="Codex Pet Share content mode for --share-list/--share-search",
    )
