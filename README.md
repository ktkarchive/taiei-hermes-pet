...
- `hermes-pet-macos/`: installable Hermes Pet macOS distribution.
- `universal-pet-app/`: reserved workspace for the future standalone app.
- `archive/`: notes for material intentionally excluded from this public MVP.
