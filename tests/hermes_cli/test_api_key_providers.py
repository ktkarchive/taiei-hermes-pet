...
PROVIDER_ENV_VARS = (
    ...
    "HERMES_COPILOT_ACP_ARGS", "COPILOT_API_BASE_URL", "COPILOT_ACP_BASE_URL",
    "ARCEE_BASE_URL", "DEEPSEEK_BASE_URL", "HF_BASE_URL", "XIAOMI_BASE_URL",
    "TOKENHUB_BASE_URL", "BEDROCK_BASE_URL", "AZURE_FOUNDRY_BASE_URL",
)
