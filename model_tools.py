...
_DYNAMIC_REQUIREMENT_TOOLSETS = {"terminal", "code_execution"}
...
def get_tool_definitions(
    ...
    cache_allowed = quiet_mode and not (
        enabled_toolsets is not None
        and bool(set(enabled_toolsets) & _DYNAMIC_REQUIREMENT_TOOLSETS)
    )
    if cache_allowed:
        try:
...
def _compute_tool_definitions(
    ...
    if "terminal" in tools_to_include:
        try:
